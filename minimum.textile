...
contained in a class name, where there’s a constant with the same name?
It’s the class.\
...
\
![Inheitance over multiple steps](images/ch_minimum_multiinherit.jpg "Inheitance over multiple steps")
\
